...
export const AIMP_PLUGIN_DEFAULT_COVER_ART_DATA_URI = `data:image/webp;base64,${Buffer.from(defaultCoverArt).toString("base64")}`;

export const AIMP_PLUGIN_RECONNECT_TIMEOUT_MS = 15000;

export const HOSTNAME_REGEX = /^[a-zA-Z]+:\/\/([\w\.]+)(\/.+)?/;

export const AIMP_PLUGIN_PLAYER_VARIABLE_PREFIX = "aimpPlayer";
export const AIMP_PLUGIN_TRACK_VARIABLE_PREFIX = "aimpTrack";
